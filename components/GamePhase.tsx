    ...
    <div className="flex flex-col h-full p-8">
      <div className="flex-1 flex flex-col items-center justify-center text-center space-y-8">
        ...
        <div className="space-y-4">
          <h2 className="text-4xl font-black text-white tracking-tight">PARTIDA EM CURSO!</h2>
          <p className="text-slate-400 max-w-xs mx-auto">
            Cada jogador diz uma palavra relacionada ao tema. Ao final, tentem descobrir quem é o impostor!
          </p>
        </div>

        <div className="grid grid-cols-1 gap-4 w-full pt-8">
          <div className="p-4 bg-slate-700/30 rounded-2xl border border-slate-700">
            <h4 className="text-slate-300 font-bold mb-1">Dica</h4>
            <p className="text-slate-500 text-sm">O impostor ganha se não for descoberto ou se conseguir adivinhar o tema!</p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8">
        {!showWinnerDialog ? (
          ...
          <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4">
            <h3 className="text-center font-bold text-slate-300 mb-2 uppercase tracking-widest text-sm">Quem venceu?</h3>
